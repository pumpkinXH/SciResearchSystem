  ...
  <div>
    ...
    <el-card>
      <el-table :data="proList" stripe style="width: 100%">
        ...
        <el-table-column prop="members" label="项目成员" width="100" />
        ...
        <el-table-column label="中期检查报告" width="110">
            <template slot-scope="scope">
        ...
        <el-form ref="proFileFormRef" :model="proForm">
          ...
          <el-form-item label="中期检查报告" :label-width="formLabelWidth" prop="interInspectUrl">
            ...
            <el-button :style="{ display: proForm.interInspectUrl == null ? 'none' : '' }" type="primary"
              style="margin-left: 10px;" @click="download(proForm.interInspectUrl)">下载<i class="el-icon-download" /></el-button>
          </el-form-item>
        </el-form>
...
export default {
  ...
  created() { // 构造函数
    this.searchModel.proStatusId = 4 // 校级申报通过
    this.getUserInfo()
  ...
  methods: {
    ...
    pass(id) {
      ...
      this.proForm.proStatusId = 5 // 中期检查申报中
