    ...
    <el-dialog :title="title" :visible.sync="dialogFormVisible" :close-on-click-modal="false" @close="clearForm">
      <el-form ref="proFormRef" :model="proForm">
        ...
        <el-form-item label="项目申报书" :label-width="formLabelWidth" prop="proProposalUrl">
          ...
          <el-button type="primary" style="margin-left: 10px;" @click="download(proForm.proProposalUrl)">下载<i
        ...
        <el-form-item :style="{ display: proForm.proStatusId < 5 ? 'none' : '' }" label="中期检查报告"
          ...
          <el-button type="primary" style="margin-left: 10px;" @click="download(proForm.interInspectUrl)">下载<i
              class="el-icon-download" /></el-button>
        </el-form-item>
        <el-form-item :style="{ display: proForm.proStatusId < 7 ? 'none' : '' }" label="项目结项书"
          ...
          <el-button type="primary" style="margin-left: 10px;" @click="download(proForm.proEndfileUrl)">下载<i
              class="el-icon-download" /></el-button>
        </el-form-item>
      </el-form>
...
export default {
  ...
  created() { // 构造函数
    this.searchModel.proStatusId = 8 // 院级结题通过
  ...
  methods: {
    ...
    pass(id) {
      ...
      this.proForm.proStatusId = 9 // 校级结题通过
