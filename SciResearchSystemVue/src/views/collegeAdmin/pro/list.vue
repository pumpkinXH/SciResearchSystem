    ...
    <el-card id="search">
      <el-row>
        <el-col :span="22">
          ...
          <el-select v-model="searchModel.proSchoolId" placeholder="请选择项目所属学院" filterable clearable>
          ...
          <el-button type="primary" icon="el-icon-search" round @click="getProList">查询</el-button></el-col>
  ...
  methods: {
    ...
    async getExcel() {
      try {
        ...
        link.href = url
        link.setAttribute('download', '项目表.xlsx')
